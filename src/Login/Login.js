...
export default function Login(props) {
	...
	return (
		<Card>
			<div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', alignContent: 'center', width:'35vw' }}>
				{/* <h1>Login</h1> */}
			...
			<div style={{ flexDirection: 'column', padding:'4vh', display: 'flex', justifyContent:'space-around', alignItems:'center' }}>
				<TextInput placeholder="username" type="text" value={userName}  onChange={e => setUsername(e.target.value)} />
